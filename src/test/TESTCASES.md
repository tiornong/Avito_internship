...
6. Негативный кейс 3 -- попытка получить данные с некорректным ID (Неправильной длины (равной нулю))
...
11. Негативный кейс 8 -- попытка получить данные с отсутствующим ID